...
export default function Toggle({
  ...
  return (
    <>
      ...
      <div className="space-y-2 text-xs absolute bottom-2 right-2 bg-black/75 rounded-xl py-3 px-4 z-10 select-none">
        {/* Toggle Bocaminas */}
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            ...
            style={{
              backgroundColor: showBocaminas ? "#66d20e" : "#cfcfcf",
            }}
          >
            <span
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            <span className="bg-[#fe6d73] w-2 h-2 rounded-full" />
          ...
          <button
            ...
            className="relative inline-flex h-4 w-7 items-center rounded-full transition-colors focus:outline-none"
            style={{
              backgroundColor: showTalleres ? "#fe6d73" : "#cfcfcf",
            }}
          >
            <span
              className={`inline-block h-3 w-3 transform rounded-full bg-white transition-transform ${

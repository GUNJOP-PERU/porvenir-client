...
export function DataTable({
  ...
  return (
    <>
      ...
      {hasNextPage && (
        <div className="w-full flex items-start justify-center h-10">
          {isFetching ? (
      ...
      <div className="flex-1 text-[9px] flex flex-col md:flex-row justify-center md:justify-between text-zinc-400">
        <span className="text-center">© 2025 Gunjop Terms Privacy Cookies</span>
      </div>
    </>
  );
}

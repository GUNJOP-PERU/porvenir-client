...
import { putDataRequest, postDataRequest } from "@/api/api";
...
export const EditPlanMonthModal = ({ isOpen, onClose, isEdit, dataCrud }) => {
  const queryClient = useQueryClient();
  const navigate = useNavigate();
  const [dataHotTable, setDataHotTable] = useState(dataCrud?.dataEdit || []);
        ...
        <DialogHeader>
          <div className="flex gap-2 items-center">
            ...
            <div>
              ...
              <DialogDescription>
                Edite los datos del plan mensual y envíe los cambios
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
            ...
            <div className="flex flex-col gap-3 z-0">
              <div>
                <h1 className="text-base font-extrabold leading-5">
                  Planificador Mensual /  {dataCrud?.month} {dataCrud?.year}
                </h1>
              </div>
              {showLoader ? (

...
export default function Layout() {
  ...
  const isTrackingPage = location.pathname === "/" || location.pathname === "/dashboard/beacon/underground-tracking" || location.pathname === "/dashboard/beacon/update-truck-plan-day";
  return (
